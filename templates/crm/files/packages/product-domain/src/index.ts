...
import { CRM_PERMISSIONS_LIST, CRM_PERMISSIONS_ROLES } from './crm';

export * from './crm';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...CRM_PERMISSIONS_LIST];
