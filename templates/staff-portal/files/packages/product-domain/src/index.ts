/**
 * Product domain — TrustOS Staff Portal.
 *
...
import { STAFF_PORTAL_PERMISSIONS_LIST, STAFF_PORTAL_PERMISSIONS_ROLES } from './staff-portal';

export * from './staff-portal';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...STAFF_PORTAL_PERMISSIONS_LIST];
...
export const PRODUCT_ROLE_PERMISSIONS: Record<string, string[]> = mergeRoles([
  STAFF_PORTAL_PERMISSIONS_ROLES,
]);
