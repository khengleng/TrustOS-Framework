/**
 * Product domain — TrustOS Helpdesk.
 *
...
import { HELPDESK_PERMISSIONS_LIST, HELPDESK_PERMISSIONS_ROLES } from './helpdesk';

export * from './helpdesk';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...HELPDESK_PERMISSIONS_LIST];
