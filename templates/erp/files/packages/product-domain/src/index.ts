...
import { ERP_PERMISSIONS_LIST, ERP_PERMISSIONS_ROLES } from './erp';

export * from './erp';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...ERP_PERMISSIONS_LIST];
