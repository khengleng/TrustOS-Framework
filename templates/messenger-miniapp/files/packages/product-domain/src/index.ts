/**
 * Product domain — TrustOS Messenger Mini App.
 *
...
import {
  MESSENGER_MINIAPP_PERMISSIONS_LIST,
  MESSENGER_MINIAPP_PERMISSIONS_ROLES,
} from './messenger-miniapp';

export * from './telegram-miniapp';
export * from './messenger-miniapp';
