/**
 * Product domain — TrustOS Collections.
 *
...
import { COLLECTION_PERMISSIONS_LIST, COLLECTION_PERMISSIONS_ROLES } from './collection';

export * from './collection';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...COLLECTION_PERMISSIONS_LIST];
