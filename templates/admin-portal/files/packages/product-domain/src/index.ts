/**
 * Product domain — TrustOS Admin Portal.
 *
...
import { ADMIN_PORTAL_PERMISSIONS_LIST, ADMIN_PORTAL_PERMISSIONS_ROLES } from './admin-portal';

export * from './admin-portal';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...ADMIN_PORTAL_PERMISSIONS_LIST];
...
export const PRODUCT_ROLE_PERMISSIONS: Record<string, string[]> = mergeRoles([
  ADMIN_PORTAL_PERMISSIONS_ROLES,
]);
