/**
 * Product domain — TrustOS Customer Portal.
 *
...
import {
  CUSTOMER_PORTAL_PERMISSIONS_LIST,
  CUSTOMER_PORTAL_PERMISSIONS_ROLES,
} from './customer-portal';

export * from './customer-portal';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...CUSTOMER_PORTAL_PERMISSIONS_LIST];
