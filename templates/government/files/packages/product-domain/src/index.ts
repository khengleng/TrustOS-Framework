/**
 * Product domain — TrustOS Government Services.
 *
...
import { GOVERNMENT_PERMISSIONS_LIST, GOVERNMENT_PERMISSIONS_ROLES } from './government';

export * from './government';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...GOVERNMENT_PERMISSIONS_LIST];
