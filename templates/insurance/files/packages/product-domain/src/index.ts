/**
 * Product domain — TrustOS Insurance.
 *
...
import { INSURANCE_PERMISSIONS_LIST, INSURANCE_PERMISSIONS_ROLES } from './insurance';

export * from './insurance';

/** Every permission this application defines, seeded alongside the framework’s. */
export const PRODUCT_PERMISSIONS: PermissionDefinition[] = [...INSURANCE_PERMISSIONS_LIST];
