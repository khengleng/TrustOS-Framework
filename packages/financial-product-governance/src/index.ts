/**
 * @trustsystem/financial-product-governance
 *
 * Ownership, change classification, maker-checker approval requirements and the audit trail.
 *
 * The approval *models* are `@trustsystem/workflow-approvals`' and are not restated here. What this
 ...
 * governance is computed from, including the one in `@trustsystem/financial-product-state-machine`
