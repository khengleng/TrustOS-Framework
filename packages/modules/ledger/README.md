...
A thin module wrapper. The implementation is in `@trustos/accounts`, `@trustos/financial-core`, `@trustos/financial-policy`, `@trustos/financial-reporting`, `@trustos/ledger`; this package contributes the declarations the platform needs — permissions,
