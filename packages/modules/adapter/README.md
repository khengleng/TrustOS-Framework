# @trustos/module-adapter

The five-method provider contract with a registry, circuit-breaker-guarded calls and lifecycle management.

## What this package is

A thin module wrapper. The implementation is in `@trustos/adapter-framework`, `@trustos/provider-sdk`; this package contributes the declarations the platform needs — permissions,
