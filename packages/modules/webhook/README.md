# @trustos/module-webhook

Outbound webhooks with HMAC signatures, overlapping secret rotation, replay protection and delivery history.

## What this package is

A thin module wrapper. The implementation is in `@trustos/webhooks`, `@trustos/webhook-runtime`; this package contributes the declarations the platform needs — permissions,
