...
1. **The implementation belongs in the framework package**, not here. This package declares and
   wires; `@trustos/ai-cache`, `@trustos/ai-gateway`, `@trustos/ai-observability`, `@trustos/ai-policy`, `@trustos/ai-sdk`, `@trustos/content-filter`, `@trustos/cost-monitor`, `@trustos/guardrails`, `@trustos/model-registry`, `@trustos/model-router`, `@trustos/prompt-registry`, `@trustos/prompt-security`, `@trustos/token-meter` does the work.
