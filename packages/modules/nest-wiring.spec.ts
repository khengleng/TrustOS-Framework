...
import { HEALTH_REGISTRY, HealthRegistry } from '@trustsystem/observability';
import { MODULE_CATALOG, requireModule } from '@trustsystem/module-registry';
import { moduleInstanceToken, type ModuleHostBinding } from '@trustsystem/module-sdk/nest';
import { FakeModelDelegate } from '@trustsystem/tenancy';
import { DocumentModule } from '@trustsystem/module-document/nest';
import { FeatureFlagsModule } from '@trustsystem/module-feature-flags/nest';
import { FileStorageModule } from '@trustsystem/module-file-storage/nest';
import { NotificationModule } from '@trustsystem/module-notification/nest';
import { ReportingModule } from '@trustsystem/module-reporting/nest';
import { SearchModule } from '@trustsystem/module-search/nest';
import { WorkflowModule } from '@trustsystem/module-workflow/nest';
